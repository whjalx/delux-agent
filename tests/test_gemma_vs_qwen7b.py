"""Dolphin-CPU (11436, -ngl 0) vs Qwen2.5-Coder-7B (11437) as contextualizer."""
...
MODELS = [
    ("Dolphin-CPU",   11436, "dolphin3.0-qwen2.5-1.5b-q4_k_m.gguf",  60),
    ("Qwen-Coder-7B", 11437, "Qwen2.5-Coder-7B-Instruct-Q4_K_M.gguf", 90),
]
...
def check_skill_selection(optimized_prompt, expected_keep, expected_drop):
